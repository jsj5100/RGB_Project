...
<div style="padding-left: 80px; margin-top: 10px;" id="kt_app_content"
		...
		<div style="padding-left: 80px;" id="kt_app_content_container"
			...
			<div class="card">
				<div class="card-body">
					<form action="./modifyTemplate.do" method="post"
						...
						<div>
							<table>
								...
								<tr>
									...
									<td class="border-td" colspan="3"><input type="text"
										name="temp_title" placeholder="제목 작성" value="${lists.temp_title}"></td>
									<td class="border-td text-center">양식번호</td>
									<td class="border-td"><input type="text"
										name="temp_id" readonly="readonly" value="${lists.temp_id}">
							...
							<textarea name="temp_content" id="editor">${lists.temp_content}</textarea>
							<div class="form-actions">
								<input type="submit" value="수정" class="btn btn-primary">
								<input type="button" value="취소" class="btn btn-danger" onclick="location.href='./templateList.do'">
							</div>
						</div>
					</form>
