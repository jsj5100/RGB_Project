			...
			<div class="card">
				<div class="card-body">
					<div class="card card-flush mb-9" id="kt_user_profile_panel">
						<div class="card-header rounded-top bgi-size-cover h-150px"
									...
									<div class="d-flex flex-column">
										<div class="d-flex align-items-center mb-2">
											<a href="#"
												...
												<%=myPageDto.getEmp_name()%>
											</a> <span class="fw-bold text-gray-600 fs-8 mb-2 d-block">
												<%=myPageDto.getEmp_gender()%>
											</span>
										</div>
										<div
											class="d-flex align-items-center flex-wrap fw-semibold fs-7 pe-2">
											<div id=tierBadge class="badge badge-lg d-inline">
												<%=myPageDto.getTier_name()%></div>
										</div>
										<script>
											document
													.addEventListener(
					...
					<div class="d-flex flex-stack fs-4 py-3 justify-content-between">
						<div class="fw-bold rotate collapsible" data-bs-toggle="collapse"
							...
							Details <span class="ms-2 rotate-180"> <i
								class="ki-duotone ki-down fs-3"></i></span>
						</div>
						<div class="d-flex">
							...
							<span data-bs-toggle="tooltip" data-bs-trigger="hover"
								...
								data-kt-initialized="1"> <a href="./myPageEdit.do"
								class="btn btn-sm btn-light-primary me-2" data-bs-toggle="modal">수정</a>
							</span>
							<%
							}
							%>
							...
							<span data-bs-toggle="tooltip" data-bs-trigger="hover"
								data-bs-original-title="Edit customer details"
								data-kt-initialized="1"> <a href="./empPageEdit.do"
								class="btn btn-sm btn-light-danger" data-bs-toggle="modal">관리자
									수정</a>
							</span>
							<%
							}
						...
						<div class="pb-5 fs-6">
							<div class="d-flex flex-wrap mt-5">
								...
								<div class="me-20 mb-3">
									...
									<div class="text-gray-600"><%=myPageDto.getEmp_no()%></div>
								</div>
								<!-- 부서 -->
								<div class="me-20 mb-3">
								...
								<div class="me-20 mb-3">
									...
									<div class="border border-dashed rounded min-w-50px py-3 px-4">
										...
										<input type="hidden" name="auth_no"
											...
											class="form-control form-control-solid" style="width: 300px;">
										<div>권한명:</div>
										<div class="text-gray-600"><%=myPageDto.getAuth_name()%></div>
									</div>
								</div>
							</div>
							<div class="fw-bold mt-5">비밀번호</div>
							<div class="text-gray-600 masked-password"
								data-password="<%=myPageDto.getEmp_password()%>"></div>
							<div class="d-flex flex-wrap mt-5">
								<!-- 주민등록번호 -->
								<div class="me-20 mb-3">
									<div class="fw-bold">주민등록번호:</div>
									<div class="text-gray-600"><%=myPageDto.getEmp_idnum()%>******
									</div>
								</div>
								<!-- 입사일 -->
								<div class="me-20 mb-3">
							...
							<div class="d-flex flex-wrap mt-5">
								...
								<div class="me-20 mb-3">
									...
									<div class="text-gray-600"><%=myPageDto.getEmp_phone()%></div>
								</div>
								<!-- 이메일 -->
								<div class="me-20 mb-3">
									<div class="fw-bold">이메일:</div>
									<div class="text-gray-600"><%=myPageDto.getEmp_email()%></div>
								</div>
								<!-- 재직여부 -->
								<div class="me-20 mb-3">
					...
					<div class="text-center pt-10">
						<button onclick="location.href='./home.do'" type="reset"
							class="btn btn-light me-3" data-kt-users-modal-action="cancel">메인화면</button>
					</div>
				</div>
			</div>
		</div>
