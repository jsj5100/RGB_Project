	...
	<div>
		<div id="kt_app_sidebar" class="app-sidebar" data-kt-drawer="true"
			...
			<div class="app-sidebar-primary">
				<div class="app-sidebar-logo d-none d-lg-flex flex-center pt-8 pb-5"
				...
				<div
					...
					data-kt-scroll-offset="5px" style="height: 765px;">
					...
					<div id="kt_header_search"
						...
						<div class="d-flex align-items-center"
							...
							<div
								...
								<i class="ki-duotone ki-magnifier fs-2"> <span class="path1"></span>
