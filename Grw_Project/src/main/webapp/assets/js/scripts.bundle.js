...
var KTAppSidebar = function() {
    ...
    return {
        init: function() {
            var n;
            (e = document.querySelector("#kt_app_sidebar_secondary_menu"),
            t = document.querySelector("#kt_app_sidebar_secondary_menu_wrapper"),
            null !== e && null !== t) && (t && (n = t.querySelector(".menu-link.active")) && !0 !== KTUtil.isVisibleInContainer(n, t) && t.scroll({
